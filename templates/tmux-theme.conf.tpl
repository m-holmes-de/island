...
set -g status-right "#[fg={{THEME_ACCENT}}]#{?pane_in_mode,COPY ,}#{?client_prefix,PREFIX ,}#{?window_zoomed_flag,ZOOM ,}#[fg={{THEME_BG_HIGHLIGHT}}]#h "
set -g window-status-format "#[fg={{THEME_BG_HIGHLIGHT}}] #I:#W "
